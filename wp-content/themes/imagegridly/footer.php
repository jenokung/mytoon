		...
		<div class="site-info">
			...
			&copy;<?php echo date('Y'); ?> <?php bloginfo( 'name' ); ?>
				...
				<span class="footer-info-right">
					<?php echo __(' | WordPress Theme by', 'imagegridly') ?> <a href="<?php echo esc_url('https://superbthemes.com/', 'imagegridly'); ?>" rel="nofollow noopener"><?php echo __(' Superb WordPress Themes', 'imagegridly') ?></a>
				</span>
