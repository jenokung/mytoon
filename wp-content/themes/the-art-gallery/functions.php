<?php 
add_action( 'wp_enqueue_scripts', 'the_art_gallery_enqueue_styles' );
function the_art_gallery_enqueue_styles() {
	wp_enqueue_style( 'the-art-gallery-parent-style', get_template_directory_uri() . '/style.css' ); 
}

// Load new fonts
function the_art_gallery_google_fonts(){
	wp_enqueue_style('the-art-gallery-google-fonts', '//fonts.googleapis.com/css2?family=Gothic+A1&display=swap', false);
}
add_action('wp_enqueue_scripts', 'the_art_gallery_google_fonts');


function the_art_gallery_customize_register( $wp_customize ) {
	function the_art_gallery_sanitize_checkbox( $input ) {
	...
	$wp_customize->add_section( 'footer_settings', array(
		'title'      => __('Footer Settings','the-art-gallery'),
		'priority'   => 1,
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'footer_headline_color', array(
		'label'       => __( 'Headline Color', 'the-art-gallery' ),
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'footer_text_color', array(
		'label'       => __( 'Text Color', 'the-art-gallery' ),
		'section'     => 'footer_settings',
		'priority'   => 1,
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'footer_link_color', array(
		'label'       => __( 'Link Color', 'the-art-gallery' ),
		'section'     => 'footer_settings',
		'priority'   => 1,
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'footer_border_color', array(
		'label'       => __( 'Border Color', 'the-art-gallery' ),
		'section'     => 'footer_settings',
		'priority'   => 1,
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'footer_background_color', array(
		'label'       => __( 'Background Color', 'the-art-gallery' ),
		'section'     => 'footer_settings',
		'priority'   => 1,
...
add_action( 'customize_register', 'the_art_gallery_customize_register' );

if(! function_exists('the_art_gallery_customizer_css' ) ):
	function the_art_gallery_customizer_css(){
		?>
		<style type="text/css">
	...
	<?php }
	add_action( 'wp_head', 'the_art_gallery_customizer_css' );
endif;


function the_art_gallery_widgets(){
	unregister_sidebar( 'sidebar-1' );
}
add_action( 'widgets_init', 'the_art_gallery_widgets', 11 );



function the_art_gallery_custom_header_setup() {
	add_theme_support( 'custom-header', apply_filters( 'the_art_gallery_custom_header_args', array(
		'default-image'          => '',
		'default-text-color'     => '000000',
		'default-image'          => get_theme_file_uri().'/img/header-img.jpg',
		'height'             	 => 400,
		'flex-height'            => true,
		'wp-head-callback'       => 'the_art_gallery_header_style',
		) ) );
	

}
add_action( 'after_setup_theme', 'the_art_gallery_custom_header_setup' );

if ( ! function_exists( 'the_art_gallery_header_style' ) ) :
	/**
	 * Styles the header image and text displayed on the blog.
	 *
	 * @see the_art_gallery_custom_header_setup().
	 */
function the_art_gallery_header_style() {
